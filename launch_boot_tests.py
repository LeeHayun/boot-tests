...
experiments_repo = Artifact.registerArtifact(
    ...
    path =  './',
    cwd = '../',
    documentation = 'main experiments repo to run full system boot tests with gem5 21.2'
)
gem5_repo = Artifact.registerArtifact(
    ...
    path =  'gem5/',
    cwd = './',
    documentation = 'cloned gem5 from googlesource and checked out v21.2.0.0'
)

m5_binary = Artifact.registerArtifact(
    command = '/usr/bin/env python3 /usr/bin/scons build/x86/out/m5',
    typ = 'binary',
    name = 'm5',
...
gem5_binary = Artifact.registerArtifact(
    ...
    /usr/bin/env python3 /usr/bin/scons build/X86/gem5.opt -j8
    ''',
    typ = 'gem5 binary',
    name = 'gem5',
    cwd = 'gem5/',
    ...
    inputs = [gem5_repo,],
    documentation = 'gem5 binary based on v21.2.0.0'
)

gem5_binary_MESI_Two_Level = Artifact.registerArtifact(
    command = '''cd gem5;
    git checkout v21.2.0.0;
    /usr/bin/env python3 /usr/bin/scons build/X86_MESI_Two_Level/gem5.opt --default=X86 PROTOCOL=MESI_Two_Level SLICC_HTML=True -j8
    ''',
    typ = 'gem5 binary',
    name = 'gem5',
    cwd = 'gem5/',
...
gem5_binary_MOESI_CMP_directory = Artifact.registerArtifact(
    command = '''cd gem5;
    git checkout v21.2.0.0;
    /usr/bin/env python3 /usr/bin/scons build/MOESI_CMP_directory/gem5.opt --default=X86 PROTOCOL=MOESI_CMP_directory -j8
    ''',
    typ = 'gem5 binary',
    name = 'gem5',
    cwd = 'gem5/',
